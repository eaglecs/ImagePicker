...
//        binding.imgProfile.setDrawableImage(R.drawable.ic_person, true)
        this.setEdgeToEdge(binding.root)
    }
...
//                    imgProfile.setLocalImage(uri, true)
                ...
                GALLERY_IMAGE_REQ_CODE -> {
                    mGalleryUri = uri
                    binding.vgContent.vgGallery.imgGallery.setLocalImage(uri)
                }
...
//            imgCameraCode -> R.drawable.img_camera_code
            binding.vgContent.vgGallery.imgGalleryCode -> R.drawable.img_gallery_code
            else -> 0
        }
...
//            imgCamera -> mCameraUri
            binding.vgContent.vgGallery.imgGallery -> mGalleryUri
            else -> null
        }
...
//            imgCameraInfo -> mCameraUri
            binding.vgContent.vgGallery.imgGalleryInfo -> mGalleryUri
            else -> null
        }
